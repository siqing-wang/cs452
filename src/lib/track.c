...
void init_tracka(track_node *track) {
    ...
    track[17].friction = 0.940;
    track[18].friction = 0.945;
    track[19].friction = 1.129;
    track[20].friction = 0.920;
    track[21].friction = 0.940;
    track[28].friction = 0.948;
    track[29].friction = 1.016;
    track[30].friction = 0.945;

    track[31].friction = 0.867;
    ...
    track[49].friction = 0.928;
    track[50].friction = 0.903;

    track[51].friction = 0.922;
    track[52].friction = 0.934;
    track[53].friction = 0.941;
    track[54].friction = 0.936;
    track[55].friction = 0.890;
    track[56].friction = 0.902;
    track[57].friction = 0.852;
    track[58].friction = 0.976;
    track[59].friction = 0.913;
    track[60].friction = 0.892;

    track[61].friction = 0.819;
    track[62].friction = 0.932;
    track[63].friction = 0.827;
    track[64].friction = 0.923;
    track[65].friction = 0.890;
    track[66].friction = 1.112;
    track[67].friction = 0.731;
    track[68].friction = 1.012;
    track[69].friction = 0.907;
    track[70].friction = 0.900;

    track[71].friction = 0.927;
    track[72].friction = 0.865;
    track[73].friction = 0.903;
    track[74].friction = 0.950;
    track[75].friction = 0.821;
    track[76].friction = 0.903;
    track[77].friction = 0.963;
    track[78].friction = 0.868;
    track[79].friction = 0.893;
}
